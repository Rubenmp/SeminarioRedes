...
\usepackage{amssymb, amsmath, amscd, amsfonts, amsthm, mathrsfs } % Símbolos matemáticoscd 
...
\input{./Temas/Intro/introduccion.tex}
\input{./Temas/Hardware/hardware.tex}
\input{./Temas/Software/software.tex}
\input{./Temas/Protocolos/miracast.tex}
\input{./Temas/Ejemplos/codigo.tex}
